 ...
 * @brief Wrappers e estruturas para execução assincrona das funções de registro da pontu.
 * @version 0.1
 * @date 2021
 * 
...
/**
 * @brief Realiza o alinhamento de uma nuvem de pontos utilizando o algoritmo de registro ICP.
 * 
