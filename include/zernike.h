...
#ifndef ZERNIKE_ORD
#define ZERNIKE_ORD 12
#endif

#ifndef ZERNIKE_REP
#define ZERNIKE_REP 8
#endif
...
/**
 * \brief Auxilliary function for valid moments count (filtering zero values)
 * \param ord Order
 * \param rep Repetitions
 * \return Quantity of valid moments
 */
int zernike_nummoments_odd(int ord, int rep);
 ...
 * \param cloud Target cloud
 * \return Dataframe with the moments
 */
